                                                ...
                                                return (
                                                    <Grid size={{ md: 6, xs: 12 }}>
                                                        <Stack spacing={1}>
                                                            {cat.company && (
                                                                <Typography variant="body2">
                                                                    <Building size={14} style={{ verticalAlign: 'middle' }} />{' '}
                                            ...
                                            <>
                                                ...
                                                <Stack spacing={2}>
                                                    {result.partialMatches.slice(0, 5).map((match) => {
                                                        ...
                                                        return (
                                                            <Paper key={match.regNumber} elevation={0} sx={{ p: 2, backgroundColor: 'grey.50' }}>
                                                                <Stack spacing={1}>
                                                                    <Stack direction="row" spacing={1} sx={{ alignItems: 'center' }}>
                                                                        <Chip label={match.regNumber} size="small" color="primary" variant="outlined" />
